...
public enum UserErrorCode implements BaseErrorCode {
    ...
    OAUTH_TOKEN_FAIL(HttpStatus.UNAUTHORIZED, "USER401", "인가코드로 토큰을 가져오는데 실패했습니다."),
    OAUTH_USER_INFO_FAIL(HttpStatus.UNAUTHORIZED, "USER401", "토큰으로 사용자 정보를 가져오는 데 실패했습니다."),
